...
async function renderScene(args: RenderSceneArgs): Promise<string> {
  ...
  const system = [
    ...
    `  • The two or three strongest sensory anchors the plan supplies. These carry the scene's atmosphere — but they support the causal chain and the emotional arc above; do not let them crowd out the beats.`,
    `  • The calm, emotionally warm tone of the story as a whole.`,
    `  • Slow but not bloated pacing — the scene breathes; it does not stall.`,
    ``,
    `━━━ FIGURATIVE LANGUAGE ━━━`,
    ``,
    `  • Metaphors sparse, similes sparse, personification rare. Do not decorate every paragraph — prefer concrete actions and precise nouns/verbs.`,
    `  • Avoid figurative language that adds no information and exists mainly to sound literary. Do not repeatedly personify the same room, weather, silence, or object across scenes.`,
    `  • One or two precise concrete details usually beat a paragraph of atmospheric description. Avoid purple prose and avoid repeating the same sensory inventory scene to scene.`,
    ``,
    `━━━ DO NOT ━━━`,
    ``,
